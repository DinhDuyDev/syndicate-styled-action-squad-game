...
ASP:dict[str, pygame.Surface] = {
    ...
    "GOAL": pygame.image.load("sprites/level_tiles/goal.png").convert(),
    ...
    "MOBSTER_0_BAR": pygame.image.load("sprites/mob_spr/mobster_0_bar.png").convert_alpha(),
    "MOBSTER_0_PISTOL": pygame.image.load("sprites/mob_spr/mobster_0_pistol.png").convert_alpha(),
    "MOBSTER_0_REVOLVER": pygame.image.load("sprites/mob_spr/mobster_0_revolver.png").convert_alpha(),
    "MOBSTER_0_SHOTGUN": pygame.image.load("sprites/mob_spr/mobster_0_shotgun.png").convert_alpha(),
    "MOBSTER_0_THOMPSON": pygame.image.load("sprites/mob_spr/mobster_0_thompson.png").convert_alpha(),
    "MOBSTER_45_BAR": pygame.image.load("sprites/mob_spr/mobster_45_bar.png").convert_alpha(),
    "MOBSTER_45_PISTOL": pygame.image.load("sprites/mob_spr/mobster_45_pistol.png").convert_alpha(),
    "MOBSTER_45_REVOLVER": pygame.image.load("sprites/mob_spr/mobster_45_revolver.png").convert_alpha(),
    "MOBSTER_45_SHOTGUN": pygame.image.load("sprites/mob_spr/mobster_45_shotgun.png").convert_alpha(),
    "MOBSTER_45_THOMPSON": pygame.image.load("sprites/mob_spr/mobster_45_thompson.png").convert_alpha(),
    "MOBSTER_90_BAR": pygame.image.load("sprites/mob_spr/mobster_90_bar.png").convert_alpha(),
    "MOBSTER_90_PISTOL": pygame.image.load("sprites/mob_spr/mobster_90_pistol.png").convert_alpha(),
    "MOBSTER_90_REVOLVER": pygame.image.load("sprites/mob_spr/mobster_90_revolver.png").convert_alpha(),
    "MOBSTER_90_SHOTGUN": pygame.image.load("sprites/mob_spr/mobster_90_shotgun.png").convert_alpha(),
    "MOBSTER_90_THOMPSON": pygame.image.load("sprites/mob_spr/mobster_90_thompson.png").convert_alpha(),
    "MOBSTER_135_BAR": pygame.image.load("sprites/mob_spr/mobster_135_bar.png").convert_alpha(),
    "MOBSTER_135_PISTOL": pygame.image.load("sprites/mob_spr/mobster_135_pistol.png").convert_alpha(),
    "MOBSTER_135_REVOLVER": pygame.image.load("sprites/mob_spr/mobster_135_revolver.png").convert_alpha(),
    "MOBSTER_135_SHOTGUN": pygame.image.load("sprites/mob_spr/mobster_135_shotgun.png").convert_alpha(),
    "MOBSTER_135_THOMPSON": pygame.image.load("sprites/mob_spr/mobster_135_thompson.png").convert_alpha(),
    "MOBSTER_180_BAR": pygame.image.load("sprites/mob_spr/mobster_180_bar.png").convert_alpha(),
    "MOBSTER_180_PISTOL": pygame.image.load("sprites/mob_spr/mobster_180_pistol.png").convert_alpha(),
    "MOBSTER_180_REVOLVER": pygame.image.load("sprites/mob_spr/mobster_180_revolver.png").convert_alpha(),
    "MOBSTER_180_SHOTGUN": pygame.image.load("sprites/mob_spr/mobster_180_shotgun.png").convert_alpha(),
    "MOBSTER_180_THOMPSON": pygame.image.load("sprites/mob_spr/mobster_180_thompson.png").convert_alpha(),
    "MOBSTER_225_BAR": pygame.image.load("sprites/mob_spr/mobster_225_bar.png").convert_alpha(),
    "MOBSTER_225_PISTOL": pygame.image.load("sprites/mob_spr/mobster_225_pistol.png").convert_alpha(),
    "MOBSTER_225_REVOLVER": pygame.image.load("sprites/mob_spr/mobster_225_revolver.png").convert_alpha(),
    "MOBSTER_225_SHOTGUN": pygame.image.load("sprites/mob_spr/mobster_225_shotgun.png").convert_alpha(),
    "MOBSTER_225_THOMPSON": pygame.image.load("sprites/mob_spr/mobster_225_thompson.png").convert_alpha(),
    "MOBSTER_270_BAR": pygame.image.load("sprites/mob_spr/mobster_270_bar.png").convert_alpha(),
    "MOBSTER_270_PISTOL": pygame.image.load("sprites/mob_spr/mobster_270_pistol.png").convert_alpha(),
    "MOBSTER_270_REVOLVER": pygame.image.load("sprites/mob_spr/mobster_270_revolver.png").convert_alpha(),
    "MOBSTER_270_SHOTGUN": pygame.image.load("sprites/mob_spr/mobster_270_shotgun.png").convert_alpha(),
    "MOBSTER_270_THOMPSON": pygame.image.load("sprites/mob_spr/mobster_270_thompson.png").convert_alpha(),
    "MOBSTER_315_BAR": pygame.image.load("sprites/mob_spr/mobster_315_bar.png").convert_alpha(),
    "MOBSTER_315_PISTOL": pygame.image.load("sprites/mob_spr/mobster_315_pistol.png").convert_alpha(),
    "MOBSTER_315_REVOLVER": pygame.image.load("sprites/mob_spr/mobster_315_revolver.png").convert_alpha(),
    "MOBSTER_315_SHOTGUN": pygame.image.load("sprites/mob_spr/mobster_315_shotgun.png").convert_alpha(),
    "MOBSTER_315_THOMPSON": pygame.image.load("sprites/mob_spr/mobster_315_thompson.png").convert_alpha(),

    "MOBSTER_0_GLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_0_glauncher.png").convert_alpha(),
    "MOBSTER_0_RLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_0_rlauncher.png").convert_alpha(),
    "MOBSTER_45_GLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_45_glauncher.png").convert_alpha(),
    "MOBSTER_45_RLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_45_rlauncher.png").convert_alpha(),
    "MOBSTER_90_GLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_90_glauncher.png").convert_alpha(),
    "MOBSTER_90_RLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_90_rlauncher.png").convert_alpha(),
    "MOBSTER_135_GLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_135_glauncher.png").convert_alpha(),
    "MOBSTER_135_RLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_135_rlauncher.png").convert_alpha(),
    "MOBSTER_180_GLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_180_glauncher.png").convert_alpha(),
    "MOBSTER_180_RLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_180_rlauncher.png").convert_alpha(),
    "MOBSTER_225_GLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_225_glauncher.png").convert_alpha(),
    "MOBSTER_225_RLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_225_rlauncher.png").convert_alpha(),
    "MOBSTER_270_GLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_270_glauncher.png").convert_alpha(),
    "MOBSTER_270_RLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_270_rlauncher.png").convert_alpha(),
    "MOBSTER_315_GLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_315_glauncher.png").convert_alpha(),
    "MOBSTER_315_RLAUNCHER": pygame.image.load("sprites/mob_spr/mobster_315_rlauncher.png").convert_alpha(),
